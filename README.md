...
Frequent itemsets for chosen support
...
This helps students connect theory, implementation, and real-world behavior.

📊 Datasets
Sparse dataset
Small baskets (2–4 items)

Fewer frequent itemsets

Fast Apriori performance

Dense dataset
Large baskets (5–9+ items)

Many overlapping items

Shows combinational explosion
